...
import com.example.everypractice.general.util.getTimeToText
...
import com.example.everypractice.prinoptions.movies.data.domain.toUnitedObject1
import com.example.everypractice.prinoptions.movies.data.domain.toUnitedObject2
import com.example.everypractice.prinoptions.movies.recycler.*
                    ...
                    RequestMovieStatus.DONE -> {
                        ...
                        sharedViewModel.showMovieWithDetails().collectLatest { movie ->
                            binding.layoutDetailOfFavouriteMovieLoader.apply {
                                ...
                                val adapter = GenresDetailAdapter(movie.genres)
                ...
                when (statusImages) {
                    ...
                    RequestMovieStatus.DONE -> {
                        sharedViewModel.showImagesFromMovie().collectLatest {  listImages ->
                            ...
                            val adapterImages = ImageMovieAdapter() {
